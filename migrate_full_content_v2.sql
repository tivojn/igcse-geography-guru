-- =====================================================
-- IGCSE Geography Guru - Full Content Migration v2
...
-- Clear existing test_yourself entries
...
('1.1', 4, 'List the four general factors affecting fertility.', 'Demographic, social/cultural, economic, political'),
...
('1.1', 6, 'Give two examples of population pressure.', 'Intense competition for land; heavy traffic congestion');
...
-- TOPIC 1.3: Population Structure
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('1.3', 1, 'At what stages of demographic transition are Bangladesh, Japan, Niger and the UK?', 'Stage 3, stage 5, stage 2, stage 4'),
('1.3', 2, 'Define dependency ratio.', 'The ratio of the number of people under 15 and over 64 years to those 15–64 years of age (per 100).'),
...
('1.6', 2, 'Explain the meaning of the term gentrification.', 'Gentrification refers to the movement of higher social or economic groups into an area after it has been renovated and restored.');

-- TOPIC 1.7: Urbanisation
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('1.7', 1, 'Define the term urbanisation.', 'Urbanisation is the process by which the proportion of a population living in urban areas increases through migration and natural increase.'),
('1.7', 2, 'Distinguish between megacities and millionaire cities.', 'A megacity is a city with over of 10 million inhabitants, whereas a millionaire city is a city with over 1 million inhabitants.');
...
-- TOPIC 2.2: Rivers
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('2.2', 1, 'Compare hydraulic action with abrasion.', 'Hydraulic action is the force of air and water on the sides of rivers and in cracks, whereas abrasion is the wearing away of the bed and bank by the load carried by a river.'),
('2.2', 2, 'Outline the difference between saltation and traction.', 'Saltation is the process whereby heavier particles are bounced or bumped along the bed of the river, whereas traction is the process whereby the heaviest material is dragged or rolled along the bed of the river.'),
('2.2', 3, 'Briefly explain the main causes of floods.', 'The main causes of floods are heavy rain, prolonged rain, snow melt, high tides, storm surges, earthquakes and landslides causing temporary lakes. Human activities can increase the flood risk by removing vegetation, making the surface impermeable and living in areas at risk of flooding.'),
...
('2.3', 2, 'Briefly explain how a wave-cut platform is formed.', 'Steep cliffs are eroded between the low-water mark and the high-water mark. As they retreat they are replaced by a lengthening platform and lower-angle cliffs, subject to weathering and mass movements rather than marine forces.'),
('2.3', 3, 'Outline the differences between fringing reefs and atolls.', 'Fringing reefs are those that grow outwards around an island, and are located on the edge of a land mass, whilst atolls are circular reefs enclosing a shallow lagoon.'),
...
-- TOPIC 2.4: Weather
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('2.4', 1, 'Outline the main features of a Stevenson screen.', 'A Stevenson screen is a wooden box standing on four legs of height about 120cm. The screen is raised so that air temperature can be measured. The sides of the box are slatted to allow air to enter freely. The roof is usually made of double boarding to prevent the Sun''s heat from reaching the inside of the screen. Insulation is further improved by painting the outside of the screen white to reflect much of the Sun''s energy. The screen is usually placed on a grass-covered surface, thereby reducing the radiation of heat from the ground.'),
('2.4', 2, 'Identify the instrument used to record relative humidity.', 'Wet- and dry-bulb thermometer'),
('2.4', 3, 'Identify the instrument used to record wind speed.', 'Anemometer'),
('2.4', 4, 'Outline the difference between a cirrus cloud and a cumulonimbus cloud.', 'Cirrus clouds are thin, wispy, high-altitude clouds, formed of ice crystals. Cumulonimbus are thick clouds extending from low altitude to high altitude, and are associated with heavy downpours and sometimes thunder and lightning.');

-- TOPIC 2.5: Climate and Natural Vegetation
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('2.5', 1, 'Compare the main climate characteristics of equatorial climates.', 'Equatorial areas have: high annual temperatures year round (26–27°C); low seasonal ranges (1–2°C), but greater diurnal (daily) ranges (10–15°C); high rainfall throughout the year (more than 2000mm).'),
('2.5', 2, 'Compare the main climate characteristics of hot desert climates.', 'Hot deserts have: high daytime temperatures (30–40°C) throughout the year; a large temperature difference, often as much as 50°C between day and night; unreliable and low rainfall (about 250mm year).'),
('2.5', 3, 'Briefly explain how climate is affected by latitude.', 'Areas that are close to the Equator receive more heat than areas that are close to the Poles because incoming solar radiation is concentrated near the Equator, but dispersed near the Poles. In addition, insolation near the Poles has to pass through a greater amount of atmosphere and there is more chance of it being reflected back out to space.'),
('2.5', 4, 'Briefly explain how climate is affected by altitude.', 'Temperature decreases with altitude. On average, it drops about 1°C for every 100 metres.'),
('2.5', 5, 'Briefly describe the vegetation characteristics of tropical rainforests.', 'Vegetation in the rainforest is evergreen. Photosynthesis and growing can happen all year. The vegetation is layered, and the shape of the crowns varies with the layer, in order to receive maximum light. It is very diverse — there are up to 200 species of tree per hectare. Trees at the top of the canopy are adapted to being in the light; those near the ground are adapted to being in the shade. The trees have buttress roots to help stabilise them.'),
('2.5', 6, 'Explain how plants are adapted to hot desert environments.', 'Plants adapt to deserts by: growing deep roots or wide roots; producing only a few leaves, to reduce transpiration (moisture loss); storing water; and producing seeds that wait for rainfall before growing and completing a very quick life cycle.');
...
('3.1', 2, 'How many countries are identified as LDCs?', '48'),
('3.1', 3, 'What is the Gini coefficient?', 'A technique used to show the extent of income inequality.'),
('3.1', 4, 'Define the product chain.', 'The full sequence of activities needed to turn raw materials into a finished product.'),
('3.1', 5, 'What is a TNC?', 'A firm that owns or controls productive operations in more than one country through foreign direct investment.'),
('3.1', 6, 'State the increase in the number of global internet users between 2000 and 2016.', 'From 361 million in 2000 to 3.4 billion in 2016');

-- TOPIC 3.2: Food Production
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('3.2', 1, 'List the three subsections of a system.', 'Inputs, processes, outputs'),
('3.2', 2, 'Define pastoral farming.', 'Livestock farming such as dairy cattle, beef cattle, sheep and pigs'),
...
('3.3', 3, 'State three human factors affecting the location of industry.', 'For example, capital, labour, markets');

-- TOPIC 3.4: Tourism
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('3.4', 1, 'When did the number of international tourist arrivals first exceed 1 billion?', '2012'),
('3.4', 2, 'What is a growth pole?', 'A particular location where economic development, such as tourism, is focused, setting off wider growth in the surrounding region.'),
('3.4', 3, 'Define economic leakages.', 'The part of the money a tourist pays for a foreign holiday that does not benefit the destination country because it goes elsewhere.');

-- TOPIC 3.5: Energy
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('3.5', 1, 'What is renewable energy?', 'Sources of energy that are not depleted as they are used.'),
('3.5', 2, 'How many people in developing countries rely on fuelwood as their main source of energy?', 'About 2.5 billion people'),
('3.5', 3, 'Name the leading countries in global wind energy production.', 'China, the USA, Germany, India and Spain');

-- TOPIC 3.6: Water
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('3.6', 1, 'How many people do not have access to an improved water source?', 'Over 660 million'),
('3.6', 2, 'What is the process that can change salt water into potable water?', 'Desalination'),
...
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('3.7', 1, 'How much wastewater is discharged into water bodies each year?', '450km³ globally'),
('3.7', 2, 'What are the two strategies used to manage acid deposition?', 'Preventing its occurrence; repairing the damage'),
('3.7', 3, 'List three consequences of enhanced global warming.', 'For example, greater global temperature variations, rising sea levels, melting of ice caps and glaciers'),
('3.7', 4, 'What are the two major causes of land degradation?', 'Deforestation and overgrazing'),
('3.7', 5, 'Define resource management.', 'The control of the exploitation and use of resources in relation to environmental and economic costs.');

-- TOPIC 4.1: Geographical Skills
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
('4.1', 1, 'State the difference between northings and eastings.', 'Northings are the horizontal lines on a map. They show how far north (or south) a place is. Eastings are the vertical lines on a map. They show how far east (or west) a place is.'),
('4.1', 2, 'State the difference between a square reference and a grid reference.', 'Square references are four-figure references, whereas grid references are six-figure references.'),
('4.1', 3, 'When would you use a square reference rather than a grid reference?', 'Square references are used to show areas, whereas grid references are used to show precise points.'),
('4.1', 4, 'Explain what a contour line is.', 'A contour line is a line that joins places of equal height.'),
('4.1', 5, 'Distinguish between a convex slope and a concave slope.', 'When contour lines are close together at the top, and then get further apart nearer the bottom, it is a concave slope. In contrast, when contour lines are close at the bottom and flatter near the top, it is a convex slope.'),
('4.1', 6, 'Define the term cross-section.', 'A view of the landscape as it would appear if sliced open, or a side-on view of the path followed if you were to walk along it. It shows variations in gradient and altitude.');
...
SELECT topic_id, COUNT(*) as definition_count FROM definitions GROUP BY topic_id ORDER BY topic_id;
