-- Migration v4: Complete IGCSE Geography Data
-- Source: Cambridge IGCSE and O Level Geography Study and Revision Guide
-- Contains ALL definitions and Test Yourself Q&A from all 19 topics

-- ============================================
-- PART 1: Clear existing data
-- ============================================
TRUNCATE TABLE definitions RESTART IDENTITY CASCADE;
TRUNCATE TABLE test_yourself RESTART IDENTITY CASCADE;

-- ============================================
-- PART 2: Seed Topics Table
-- ============================================
-- First, clear and re-seed topics to ensure proper IDs
...
(1, 'Population and Settlement', '1.1', 'Population dynamics', '2-11'),
(1, 'Population and Settlement', '1.2', 'Migration', '12-16'),
(1, 'Population and Settlement', '1.3', 'Population structure', '17-19'),
(1, 'Population and Settlement', '1.4', 'Population density and distribution', '20-22'),
(1, 'Population and Settlement', '1.5', 'Settlements and service provision', '23-25'),
(1, 'Population and Settlement', '1.6', 'Urban settlements', '26-29'),
(1, 'Population and Settlement', '1.7', 'Urbanisation', '30-33'),
(2, 'The Natural Environment', '2.1', 'Earthquakes and volcanoes', '34-39'),
(2, 'The Natural Environment', '2.2', 'Rivers', '40-45'),
(2, 'The Natural Environment', '2.3', 'Coasts', '46-52'),
(2, 'The Natural Environment', '2.4', 'Weather', '53-56'),
(2, 'The Natural Environment', '2.5', 'Climate and natural vegetation', '57-63'),
(3, 'Economic Development', '3.1', 'Development', '64-73'),
(3, 'Economic Development', '3.2', 'Food production', '74-80'),
(3, 'Economic Development', '3.3', 'Industry', '81-85'),
(3, 'Economic Development', '3.4', 'Tourism', '86-90'),
(3, 'Economic Development', '3.5', 'Energy', '91-98'),
(3, 'Economic Development', '3.6', 'Water', '99-102'),
(3, 'Economic Development', '3.7', 'Environmental risks of economic development', '103-111'),
(4, 'Geographical Skills and Investigations', '4.1', 'Geographical skills', '112-122'),
(4, 'Geographical Skills and Investigations', '4.2', 'Geographical investigations', '123-124');
...
((SELECT id FROM topics WHERE topic_number = '1.1'), 'Total fertility rate', 'The average number of children a women has during her lifetime.'),
...
((SELECT id FROM topics WHERE topic_number = '2.1'), 'Richter scale', 'An open-ended scale to record magnitude of earthquakes – the higher the number on the scale, the greater the strength of the earthquake. There are more small earthquakes than large earthquakes.'),
...
((SELECT id FROM topics WHERE topic_number = '2.1'), 'Focus', 'The position within the Earth where an earthquake occurs. Earthquakes may be divided into shallow-focus and deep-focus earthquakes depending on how far below the Earth''s surface they occur.');
...
((SELECT id FROM topics WHERE topic_number = '2.2'), 'Infiltration', 'The movement of water into the soil. The rate at which water enters the soil (the infiltration rate) depends on the intensity of rainfall, the permeability of the soil, and the extent to which it is already saturated with water.'),
...
((SELECT id FROM topics WHERE topic_number = '2.2'), 'Overland flow', 'Overland movement of water after a rainfall. It is the fastest way in which water reaches a river. The amount of overland runoff increases with heavy and prolonged rainfall, steep gradients, lack of vegetation cover, and saturated or frozen soil.'),
((SELECT id FROM topics WHERE topic_number = '2.2'), 'Abrasion (or corrasion)', 'The wearing away of the bed and bank by the load carried by a river.'),
...
((SELECT id FROM topics WHERE topic_number = '2.2'), 'Groundwater flow', 'The movement of water from land to river through rock. It is the slowest form of such water movement, and accounts for the constant flow of water in rivers during times of low rainfall.'),
...
((SELECT id FROM topics WHERE topic_number = '2.2'), 'Solution', 'The removal of chemical ions, especially calcium, which cause rocks to dissolve. The chemical load is carried dissolved in the water.'),
...
-- Topic 2.3 - Coasts
INSERT INTO definitions (topic_id, term, definition) VALUES
((SELECT id FROM topics WHERE topic_number = '2.3'), 'Abrasion (or corrasion)', 'The wearing away of the cliffs by the load carried by the sea.'),
((SELECT id FROM topics WHERE topic_number = '2.3'), 'Hydraulic action', 'The force of air and water when the waves break.'),
((SELECT id FROM topics WHERE topic_number = '2.3'), 'Solution (or corrosion)', 'The removal of chemical ions, especially calcium, which cause rocks to dissolve.'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Gross National Product (GNP)', 'The total value of goods and services produced by a country in a year, plus income earned by the country''s residents from foreign investments and minus income earned within the domestic economy by overseas residents.'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Human Development Index (HDI)', 'Combines four indicators of development: life expectancy at birth; mean years of schooling for adults aged 25 years; expected years of schooling for children of school entering age; GNI per capita (PPP$).'),
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Least developed countries (LDCs)', 'The poorest of the developing countries. They have major economic, institutional and human resource problems.'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Cumulative causation', 'The process whereby a significant increase in economic growth can lead to even more growth as more money circulates in the economy.'),
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Formal sector', 'That part of an economy known to the government department responsible for taxation and to other government offices.'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 'Transnational corporation (TNC)', 'A firm that owns or controls productive operations in more than one country through foreign direct investment (FDI).'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 'New international division of labour (NIDL)', 'Divides production into different skills and tasks that are often spread across a number of countries.');
...
-- Topic 3.3 - Industry
INSERT INTO definitions (topic_id, term, definition) VALUES
((SELECT id FROM topics WHERE topic_number = '3.3'), 'By-product', 'Something that is left over from the main production process, which has some value and therefore can be sold.'),
((SELECT id FROM topics WHERE topic_number = '3.3'), 'Waste product', 'All manufacturing industries produce waste product that has no value and must be disposed of. Costs will be incurred in the disposal of waste product.'),
...
((SELECT id FROM topics WHERE topic_number = '3.3'), 'Greenfield locations', 'An area of agricultural land or some other undeveloped site earmarked for commercial development or industrial projects.');

-- Topic 3.4 - Tourism
INSERT INTO definitions (topic_id, term, definition) VALUES
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Tourism', 'Travel away from the home environment: (a) for leisure, recreation and holidays; (b) to visit friends and relations (VFR); (c) for business and professional reasons.'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Package tour', 'The most popular form of foreign holiday where travel, accommodation and meals may all be included in the price and booked in advance.'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Growth pole', 'A particular location where economic development, in this case tourism, is focused, setting off wider growth in the region as a whole.'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Economic leakages', 'The part of the money a tourist pays for a foreign holiday that does not benefit the destination country because it goes elsewhere.'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Multiplier effect', 'The idea that an initial amount of spending or investment causes money to circulate in the economy, bringing a series of economic benefits over time.'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Sustainable tourism', 'Tourism organised in such a way that its level can be sustained in the future without creating irreparable environmental, social and economic damage to the receiving area.'),
...
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Ecotourism', 'A specialised form of tourism where people experience relatively untouched natural environments, such as coral reefs, tropical forests and remote mountain areas, and ensures that their presence does no further damage to these environments.'),
...
((SELECT id FROM topics WHERE topic_number = '3.4'), 'Community tourism', 'A form of tourism which aims to include and benefit local communities, particularly in developing countries.'),
...
-- Topic 3.5 - Energy
INSERT INTO definitions (topic_id, term, definition) VALUES
((SELECT id FROM topics WHERE topic_number = '3.5'), 'Fossil fuels', 'Fuels consisting of hydrocarbons (coal, oil and natural gas), formed by the decomposition of prehistoric organisms in past geological periods.'),
...
((SELECT id FROM topics WHERE topic_number = '3.5'), 'Biofuels', 'Fossil fuel substitutes that can be made from a range of crops including oilseeds, wheat and sugar. They can be blended with petrol and diesel.'),
...
-- Topic 3.6 - Water
INSERT INTO definitions (topic_id, term, definition) VALUES
((SELECT id FROM topics WHERE topic_number = '3.6'), 'Water supply', 'The provision of water by public utilities, commercial organisations or by community endeavours.'),
...
((SELECT id FROM topics WHERE topic_number = '3.6'), 'Wells and boreholes', 'A means of tapping into various types of aquifers (water-bearing rocks), gaining access to groundwater.'),
...
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Enhanced greenhouse effect', 'Large-scale pollution of the atmosphere by economic activities has created an enhanced greenhouse effect.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Deforestation', 'The loss of forested lands for a number of reasons including the clearing of land for agricultural use, for timber, and for other activities such as mining.'),
...
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Dust storm', 'A severe windstorm that sweeps clouds of dust across an extensive area, especially in an arid region.'),
...
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Sustainable development', 'A carefully calculated system of resource management which ensures that the current level of exploitation does not compromise the ability of future generations to meet their own needs.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Environmental impact statement', 'A document required by law detailing all the impacts on the environment of an energy or other project above a certain size.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Conservation of resources', 'The management of the human use of natural resources to provide the maximum benefit to current generations while maintaining capacity to meet the needs of future generations.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Recycling', 'The concentration of used or waste materials, their reprocessing, and their subsequent use in place of new materials.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Reuse', 'Extending the life of a product beyond what was the norm in the past, or putting a product to a new use and extending its life in this way.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Quotas', 'Involving agreement between countries to take only a predetermined amount of a resource.'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Rationing', 'A last resort management strategy when demand is massively out of proportion to supply. For example, individuals might only be allowed a very small amount of fuel and food per week.'),
...
((SELECT id FROM topics WHERE topic_number = '3.7'), 'Carbon trading', 'A company that does not use up the level of emissions it is entitled to can sell the remainder of its entitlement to another company.'),
...
((SELECT id FROM topics WHERE topic_number = '4.1'), 'Cross-section', 'A view of the landscape as it would appear if sliced open, or if you were to walk along it.');

-- ============================================
-- PART 4: TEST YOURSELF Q&A
-- ============================================

-- Topic 1.1 - Population dynamics (6 questions)
...
-- Topic 1.2 - Migration (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
...
-- Topic 1.3 - Population structure (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
...
-- Topic 1.4 - Population density and distribution (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
...
-- Topic 1.5 - Settlements and service provision (4 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
...
-- Topic 1.6 - Urban settlements (2 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '1.6'), 1, 'Distinguish between urban sprawl and urban renewal.', 'Urban sprawl is the unchecked outward spread of built-up areas, caused by their expansion. Urban renewal refers to the improvement of existing buildings.'),
((SELECT id FROM topics WHERE topic_number = '1.6'), 2, 'Explain the meaning of the term gentrification.', 'Gentrification refers to the movement of higher social or economic groups into an area after it has been renovated and restored.');

-- Topic 1.7 - Urbanisation (2 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '1.7'), 1, 'Define the term urbanisation.', 'Urbanisation is the process by which the proportion of a population living in urban areas increases through migration and natural increase.'),
...
-- Topic 2.1 - Earthquakes and volcanoes (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '2.1'), 1, 'State the difference between dormant and extinct volcanoes.', 'A dormant volcano is a volcano that has not erupted for a very long time but could erupt again. In contrast, an extinct volcano is a volcano that has shown no signs of volcanic activity in historical times.'),
((SELECT id FROM topics WHERE topic_number = '2.1'), 2, 'Distinguish between destructive and constructive plate boundaries.', 'A destructive plate boundary is one where oceanic crust moves towards the continental crust and sinks beneath it, due to its higher density. Material is destroyed at a destructive plate boundary. In contrast, at a constructive plate boundary, new oceanic crust is formed as the two plates move apart.'),
...
((SELECT id FROM topics WHERE topic_number = '2.3'), 2, 'Briefly explain how a wave-cut platform is formed.', 'Steep cliffs are eroded between the low-water mark and the high-water mark. As they retreat they are replaced by a lengthening platform and lower-angle cliffs, subject to weathering and mass movements rather than marine forces.'),
((SELECT id FROM topics WHERE topic_number = '2.3'), 3, 'Outline the differences between fringing reefs and atolls.', 'Fringing reefs are those that grow outwards around an island, and are located on the edge of a land mass, whilst atolls are circular reefs enclosing a shallow lagoon.'),
((SELECT id FROM topics WHERE topic_number = '2.3'), 4, 'Distinguish between gabions and sea walls.', 'Gabions are rocks held in wire cages and absorb wave energy, whereas sea walls are large-scale concrete structures designed to deflect wave energy.');

-- Topic 2.4 - Weather (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '2.4'), 1, 'Outline the main features of a Stevenson screen.', 'A Stevenson screen is a wooden box standing on four legs of height about 120cm. The screen is raised so that air temperature can be measured. The sides of the box are slatted to allow air to enter freely. The roof is usually made of double boarding to prevent the Sun''s heat from reaching the inside of the screen. Insulation is further improved by painting the outside of the screen white to reflect much of the Sun''s energy. The screen is usually placed on a grass-covered surface, thereby reducing the radiation of heat from the ground.'),
((SELECT id FROM topics WHERE topic_number = '2.4'), 2, 'Identify the instruments used to record: (a) relative humidity (b) wind speed.', '(a) Wet- and dry-bulb thermometer (b) Anemometer'),
((SELECT id FROM topics WHERE topic_number = '2.4'), 3, 'Outline the difference between a cirrus cloud and a cumulonimbus cloud.', 'Cirrus clouds are thin, wispy, high-altitude clouds, formed of ice crystals. Cumulonimbus are thick clouds extending from low altitude to high altitude, and are associated with heavy downpours and sometimes thunder and lightning.');

-- Topic 2.5 - Climate and natural vegetation (4 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '2.5'), 1, 'Compare the main climate characteristics of (a) equatorial climates and (b) hot desert climates.', '(a) Equatorial areas have: high annual temperatures year round (26–27°C); low seasonal ranges (1–2°C), but greater diurnal (daily) ranges (10–15°C); high rainfall throughout the year (more than 2000mm). (b) Hot deserts have: high daytime temperatures (30–40°C) throughout the year; a large temperature difference, often as much as 50°C between day and night; unreliable and low rainfall (about 250mm/year).'),
((SELECT id FROM topics WHERE topic_number = '2.5'), 2, 'Briefly explain how climate is affected by (a) latitude and (b) altitude.', '(a) Areas that are close to the Equator receive more heat than areas that are close to the Poles because incoming solar radiation is concentrated near the Equator, but dispersed near the Poles. In addition, insolation near the Poles has to pass through a greater amount of atmosphere and there is more chance of it being reflected back out to space. (b) Temperature decreases with altitude. On average, it drops about 1°C for every 100 metres.'),
((SELECT id FROM topics WHERE topic_number = '2.5'), 3, 'Briefly describe the vegetation characteristics of tropical rainforests.', 'Vegetation in the rainforest is evergreen. Photosynthesis and growing can happen all year. The vegetation is layered, and the shape of the crowns varies with the layer, in order to receive maximum light. It is very diverse — there are up to 200 species of tree per hectare. Trees at the top of the canopy are adapted to being in the light; those near the ground are adapted to being in the shade. The trees have buttress roots to help stabilise them.'),
((SELECT id FROM topics WHERE topic_number = '2.5'), 4, 'Explain how plants are adapted to hot desert environments.', 'Plants adapt to deserts by: growing deep roots or wide roots; producing only a few leaves, to reduce transpiration (moisture loss); storing water; and producing seeds that wait for rainfall before growing and completing a very quick life cycle.');

-- Topic 3.1 - Development (6 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '3.1'), 1, 'List the indicators used in the Human Development Index (HDI).', 'Life expectancy at birth, mean years of schooling for adults aged 25 years, expected years of schooling for children of school entering age, GNI per capita (PPP$)'),
((SELECT id FROM topics WHERE topic_number = '3.1'), 2, 'How many countries are identified as LDCs (Least Developed Countries)?', '48'),
...
((SELECT id FROM topics WHERE topic_number = '3.1'), 5, 'What is a transnational corporation (TNC)?', 'A firm that owns or controls productive operations in more than one country through foreign direct investment.'),
((SELECT id FROM topics WHERE topic_number = '3.1'), 6, 'State the increase in the number of global internet users between 2000 and 2016.', 'From 361 million in 2000 to 3.4 billion in 2016');
...
-- Topic 3.3 - Industry (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
...
-- Topic 3.4 - Tourism (3 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '3.4'), 1, 'When did the number of international tourist arrivals first exceed 1 billion?', '2012'),
((SELECT id FROM topics WHERE topic_number = '3.4'), 2, 'What is a growth pole?', 'A particular location where economic development, such as tourism, is focused, setting off wider growth in the surrounding region.'),
...
-- Topic 3.7 - Environmental risks of economic development (6 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '3.7'), 1, 'Draw a labelled diagram showing an externality gradient and field.', 'See Figure 3.20 on page 104. (Diagram showing: Maximum environmental impact at location of industry, Externality gradient showing decrease with distance, Externality field showing geographical extent of impact)'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 2, 'How much wastewater is discharged into water bodies each year?', '450km³ globally'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 3, 'What are the two strategies used to manage acid deposition?', 'Preventing its occurrence; repairing the damage'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 4, 'List three consequences of enhanced global warming.', 'For example, greater global temperature variations, rising sea levels, melting of ice caps and glaciers'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 5, 'What are the two major causes of land degradation?', 'Deforestation and overgrazing'),
((SELECT id FROM topics WHERE topic_number = '3.7'), 6, 'Define resource management.', 'The control of the exploitation and use of resources in relation to environmental and economic costs.');

-- Topic 4.1 - Geographical skills (8 questions)
INSERT INTO test_yourself (topic_id, question_number, question, answer) VALUES
((SELECT id FROM topics WHERE topic_number = '4.1'), 1, 'State the difference between northings and eastings.', 'Northings are the horizontal lines on a map. They show how far north (or south) a place is. Eastings are the vertical lines on a map. They show how far east (or west) a place is.'),
...
((SELECT id FROM topics WHERE topic_number = '4.1'), 5, 'Distinguish between a convex slope and a concave slope.', 'When contour lines are close together at the top, and then get further apart nearer the bottom, it is a concave slope. In contrast, when contour lines are close at the bottom and flatter near the top, it is a convex slope.'),
((SELECT id FROM topics WHERE topic_number = '4.1'), 6, 'Define the term cross-section.', 'A view of the landscape as it would appear if sliced open, or a side-on view of the path followed if you were to walk along it. It shows variations in gradient and altitude.'),
((SELECT id FROM topics WHERE topic_number = '4.1'), 7, 'The world''s population is approximately 7.5 billion and China''s population is approximately 1.3 billion. Express China''s population as a percentage of the world''s population.', '17%'),
((SELECT id FROM topics WHERE topic_number = '4.1'), 8, 'Express 7,503,875,592 in terms of: (a) four significant figures (b) seven significant figures (c) nine significant figures', '(a) 7,504,000,000 (b) 7,503,876,000 (c) 7,503,875,590');

-- ============================================
-- PART 5: Verification Queries
-- ============================================

-- Count definitions by topic
SELECT t.topic_number, t.topic_name, COUNT(d.id) as definition_count
FROM topics t
LEFT JOIN definitions d ON t.id = d.topic_id
GROUP BY t.id, t.topic_number, t.topic_name
ORDER BY t.topic_number;

-- Count test_yourself questions by topic
SELECT t.topic_number, t.topic_name, COUNT(ty.id) as question_count
FROM topics t
LEFT JOIN test_yourself ty ON t.id = ty.topic_id
GROUP BY t.id, t.topic_number, t.topic_name
ORDER BY t.topic_number;

-- Total counts
SELECT 'Total Topics' as metric, COUNT(*) as count FROM topics
UNION ALL
SELECT 'Total Definitions', COUNT(*) FROM definitions
UNION ALL
SELECT 'Total Test Yourself Questions', COUNT(*) FROM test_yourself;
